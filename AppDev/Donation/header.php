...
/*========== Donation Section======*/
  ...
  <body>
      ...
      id="mainNav">
          ...
          <a class="navbar-brand text-white"href="index.php">Funding is Helping</a>
        ...
        <div class="collapse navbar-collapse"id="myNavbar">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                ...
                <li class="nav-item"><a class="nav-link active" href="posting.php">Fundraising Postings</a></li>
                ...
                <li class="nav-item"><a class="nav-link active" href="register.php">SingUp</a></li>
